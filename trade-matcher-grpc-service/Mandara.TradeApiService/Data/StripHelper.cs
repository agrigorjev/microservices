...
public static class StripHelper
{
    ...
    public static readonly string StripNameBalmoVariants = $"{StandardBalmoName}|{DailyBalmoName}|{CustomPeriodBalmoName}";

    public static readonly string StripNameCustomVariants = "Custom Monthly";

    public static readonly string StripNameDailyVariants = "Custom CFD|Custom CFD (Month)";
