...
namespace Mandara.Entities
{
    ...
    public class OfficialProduct
    {
        ...
        public OfficialProduct()
        {
            ...
            ParsedProducts = new HashSet<ParsedProduct>();
            ParserDefaultProducts = new HashSet<ParserDefaultProduct>();
            Swaps = new HashSet<Product>();
            HALProducts = new HashSet<HALProduct>();
            official_products1 = new HashSet<OfficialProduct>();
            IMQQuotes = new HashSet<IMQQuote>();
            products1 = new HashSet<Product>();
            UnderlyingFuturesOverridesProducts = new HashSet<Product>();
            MonthlyProducts = new HashSet<Product>();
        ...
        [NotMapped]
        public string SettleSymbol => PlattsSymbolConfig?.PlattsSymbol ?? "";
        ...
        public virtual ICollection<Product> MonthlyProducts { get; set; }

        public virtual ICollection<ParserWord> ParserWords { get; set; }

        public virtual ICollection<ParsedProduct> ParsedProducts { get; set; }
        public virtual ICollection<ParserDefaultProduct> ParserDefaultProducts { get; set; }
        public virtual ICollection<Product> Swaps { get; set; }
        public virtual ICollection<HALProduct> HALProducts { get; set; }
        public virtual ICollection<IMQQuote> IMQQuotes { get; set; }

        public virtual ICollection<OfficialProduct> official_products1 { get; set; }
        public virtual ICollection<Product> products1 { get; set; }
        public virtual ICollection<Product> UnderlyingFuturesOverridesProducts { get; set; }

        public virtual PlattsSymbolConfig PlattsSymbolConfig { get; set; }
