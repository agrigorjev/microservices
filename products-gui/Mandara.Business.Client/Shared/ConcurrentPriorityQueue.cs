...
{
    /// <summary>Provides a thread-safe priority queue data structure. 
    /// Taken from: https://github.com/dotnet/samples/blob/main/csharp/parallel/ParallelExtensionsExtras/CoordinationDataStructures/ConcurrentPriorityQueue.cs 
    /// to replace use of the MSFT.ParallelExtensionsExtras nuget package, which is obselete due to newer libraries in the framework.
    /// </summary>
